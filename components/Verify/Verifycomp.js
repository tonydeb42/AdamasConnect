...
const Verifycomp = () => {
    ...
    <>
      ...
      <div className="mb-3">
        ...
        <input
          ...
          onChange={(e) => {
            changeHandler(e.target.value, "stream");
          }}
          autoComplete="off"
          required
        />
      ...
      <div className="mb-3">
        ...
        <input
          ...
          onChange={(e) => {
            changeHandler(e.target.value, "semester");
          }}
          autoComplete="off"
          required
        />
  ...
  return (
    <div className={styles.verifycontainer} style={{ backgroundColor: "black" }}>
      <div>
        <center>
          <Image src={logo} alt="connect_logo" style={{ height: "200px", width: "200px" }} />
        </center>
        <center className="mt-3">
          <h1 className={styles.title}>{isLogged ? "Login" : "Sign Up"}</h1>
        </center>
