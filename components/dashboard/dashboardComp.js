    ...
    <div
      ...
      <div className="tw-flex  tw-flex-col tw-w-full tw-mt-6 tw-px-5 lg:tw-mx-auto">
        <div className="tw-flex  tw-flex-col tw-w-full lg:tw-mx-auto ">
          ...
          />
          <div className="lg:tw-ml-44 tw-flex tw-items-center tw-gap-4">
            {isUploading && (
                  ...
                  images.map((link, index) => (
                    <div
                      ...
                      <div className="tw-float-right">
                        <button className="btn btn-danger" onClick={() => deletePhoto(index)}>
                          <svg
            ...
            <label className="tw-w-20 tw-h-14 tw-mt-5 tw-flex tw-justify-center tw-items-center tw-text-sm tw-text-white tw-gap-1 tw-rounded-lg border  tw-cursor-pointer tw-flex-col ">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
